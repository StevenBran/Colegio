 ...
 * @author asd
 */
public class PensumVista extends javax.swing.JFrame {

    /**
     * Creates new form PensumVista
     */
    public PensumVista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Año del pensum");
            ...
            .addGroup(jPanelRound1Layout.createSequentialGroup()
                .addGroup(jPanelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelRound1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_año, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelRound1Layout.createSequentialGroup()
                        .addGap(126, 126, 126)
...
String fecha= txt_año.getText();
        try {
            // TODO add your handling code here:
            Conexion con = new Conexion();
            Connection conn = con.getConexion();
            JasperReport reporte = null;
            String patch ="src\\vista\\ReportePensum.jasper";
            reporte =(JasperReport) JRLoader.loadObjectFromFile(patch);
             Map parametroP = new HashMap();
            parametroP.put("año",fecha);
             jprint = JasperFillManager.fillReport(reporte,parametroP,conn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PensumVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PensumVista().setVisible(true);
            }
        });
    }
